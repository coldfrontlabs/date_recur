<?php
namespace Drupal\date_recur\Plugin\views\style;
use Drupal\date_recur\Plugin\views\row\DateRecurCalendar as CalendarRowRecur;
 ...
 *
 * @ViewsStyle(
 *   id = "date_recur_calendar",
 *   title = @Translation("Calendar (with Date Recur)"),
 ...
 * )
 */
class DateRecurCalendar extends StylePluginBase {
  ...
  protected function hasCalendarRowPlugin() {
    return $this->view->rowPlugin instanceof CalendarRow || $this->view->rowPlugin instanceof CalendarRowRecur;
  }
